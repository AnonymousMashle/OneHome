...
unset($_SESSION['login_errors'], $_SESSION['login_email'], $_SESSION['register_success']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="login-body">
            ...
            <form class="login-form" method="POST" action="login_process.php">
                <div class="field">
                    ...
                    <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($loginEmail, ENT_QUOTES, 'UTF-8'); ?>" required />
                </div>
